...
\newcommand{\NombreAlumno}{Ana Zavala Arias}
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Sistema Web de Gestión Documental y Generación de Códigos QR para el PJETAM} 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Sistema Web de Gestión Documental y Generación de \\ Códigos QR para el PJETAM}
...
\newcommand{\Matricula}           {2430118}  %SU MATRICULA
...
\ClearWallPaper
\thispagestyle{fancy}
%esto estaba asi en la plantilla
%\addcontentsline{toc}{section}{Resumen}
%\vspace*{1cm}

%esto estaba como \section*{Resumen}
\input{resumen}
...
%esto estaba como \section*{Abstract}
\input{abstract}
