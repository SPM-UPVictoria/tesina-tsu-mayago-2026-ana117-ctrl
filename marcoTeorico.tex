...
La nube hace referencia a diversos recursos informáticos que se comparten en internet, como los servicios de almacenamiento de datos, esta tecnologia nos permite almacenar datos, documentos, aplicaciones y más, con la ventaja de acceder desde cualquier lugar del mundo \cite{almaceamientoNube2024}.

\subsubsection{Uso de almacenamiento en la nube en entornos legales}
...
\cite{NubeAmbitoLegal2025} Resalta una problemática persistente en el ámbito jurídico, que es el uso excesivo de documentos físicos, lo cual retrasa la digitalización de procesos y limita el aprovechamiento de herramientas tecnológicas, como el almacenamiento en la nube. Esta resistencia impide una gestión documental más ágil y segura, dificultando la transición hacia entornos digitales modernos.
